      ...
      <div className="league">
        <Helmet title="Leagues" />
          ...
          <div className="league-header">
            <div className="header-item col-md-5">
            ...
            <div className="header-image col-md-7">
              <Photo className="league-photo" photoClassName="img-responsive" src={tempIMG} parentsHeight={""} />
            </div>
